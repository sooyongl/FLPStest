...
for(i in 1:10) {
  ...
  o <- list(fit=fit, sdat=sdat)
  saveRDS(o, file.path("test/check_data_generation/results",paste0("normal01ztwo_2pl_", i, ".rds")))
  rm(fit)
  ...
  # )
  # o <- list(fit=fit, sdat=sdat)
  # saveRDS(o, file.path("test/check_data_generation/results",paste0("perflognzcompleztwocont_2pl_", i, ".rds")))
  #
  # rm(fit)
  #
  # gc()
...
files <- str_subset(files, "normal01ztwo_2pl_")
...
saveRDS(results, "test/check_data_generation/results222222.rds")

results <- readRDS("test/check_data_generation/results.rds")
results11 <- readRDS("test/check_data_generation/results222222.rds")

saveRDS(c(results, results11), "test/check_data_generation/results2.rds")
