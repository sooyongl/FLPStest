library(tidyverse)
library(ggforce)
res <- readRDS("results/cleaned/res_extracted_cleaned.rds")
...
# -------------------------------------------------------------------------
a1 <- readRDS("F:/FLPS/results/cleaned/0317_res_extracted_1.rds")
...
## rasch
a1 <- readRDS("F:/FLPS/results/cleaned/0317_res_extracted_135.rds")
...
## grm
a1 <- readRDS("F:/FLPS/results/cleaned/0317_res_extracted_50.rds")
...
## gpcm
a1 <- readRDS("F:/FLPS/results/cleaned/0317_res_extracted_80.rds")
